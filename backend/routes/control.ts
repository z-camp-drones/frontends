...
const singleExecutionAndAsyncHandler = (fn: RequestHandler) => singleExecution(asyncMiddleware(fn))
...
router.put('/connect', singleExecutionAndAsyncHandler(async (req: Request, res: Response) => {
    await sdk.control.connect();
    okResponse(res, "connected");
}));

router.put('/takeoff', singleExecutionAndAsyncHandler(async (req: Request, res: Response) => {
...
router.put('/land', singleExecutionAndAsyncHandler(async (req: Request, res: Response) => {
    await sdk.control.land();
    okResponse(res, "landed");
}));

router.put('/emergency', asyncMiddleware(async (req: Request, res: Response) => {
    await sdk.control.emergency();
    okResponse(res, "emergency-stop");
}));

router.put('/stop', singleExecutionAndAsyncHandler(async (req: Request, res: Response) => {
 ...
 *
 */
router.put('/go', singleExecutionAndAsyncHandler(async (req: Request, res: Response) => {
...
router.put('/rotate/:degrees', singleExecutionAndAsyncHandler(async (req: Request, res: Response) => {
